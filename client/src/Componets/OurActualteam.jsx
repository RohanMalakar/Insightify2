...
export default function OurActualteam() {
  ...
  return (
    <div className='w-full pt-24 h-[] border-3 border-gray-800 p-2 flex flex-col bg-purple-200 py-10 gap-y-6'>
      {/*  ----------- First section ----------- */}
      <div className='w-100% flex flex-col gap-4'>
        {/* Image */}
        <div className='w-[100%] flex justify-center'>
          <AiOutlineTeam className='text-[5rem]  rounded-[50%] p-1 text-white bg-purple-600 z-10 shadow-2xl shadow-indigo-500 ' />
        </div>
        {/* Heading */}
